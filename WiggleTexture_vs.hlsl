...
WiggleTextureShaderInput main(BasicVertex modelVertex)
{
    WiggleTextureShaderInput output; // This is the data the pixel shader requires from this vertex shader
