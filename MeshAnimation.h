...
#ifndef _MESHANIMATION_H_INCLUDED_
#define _MESHANIMATION_H_INCLUDED_
...
public:
    ...
    MeshAnimation(const std::string& fileName, bool requireTangents = false);
    ~MeshAnimation();
    ...
    void RenderAnimation(std::vector<CMatrix4x4>& modelMatrices);
